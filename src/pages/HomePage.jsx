    ...
    <SpaceBetween size="m">
      ...
      >
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: 16 }}>
          {[
            { icon: '🧠', color: '#6936d3', bg: '#1a1033', border: '#6936d340',
              org: 'GenAI-2026 Cohort', role: 'GenAI Trainer & Curriculum Architect',
              detail: '21-module GenAI curriculum — from NLP foundations to production AI systems',
              tag: 'Self-run · Ongoing' },
            { icon: '🎓', color: '#0073bb', bg: '#0d1f33', border: '#0073bb40',
              org: 'KnowledgeHut upGrad', role: 'Director of Data Science',
              detail: 'Led data science education programmes and corporate training delivery globally',
              tag: '2023' },
            { icon: '📡', color: '#1d8102', bg: '#0d2a14', border: '#1d810240',
              org: 'Great Learning', role: 'Data Science Mentor',
              detail: 'Mentored 1,000+ professionals in ML and Python across online cohorts',
              tag: '2019 – 2021' },
            { icon: '📘', color: '#ff9900', bg: '#2a1a00', border: '#ff990040',
              org: 'Packt Publishing', role: 'Author & Technical Editor',
              detail: 'Co-authored Data Science with Python — 426 pages, published internationally',
              tag: '2019' },
          ].map(item => (
            <div key={item.org} style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <span style={{
                  fontSize: 11, color: item.color, background: `${item.color}18`,
              ...
              {/* Org name */}
              <div style={{ color: '#e9ebed', fontWeight: 700, fontSize: 15 }}>{item.org}</div>

              {/* Role */}
              <div style={{ color: item.color, fontSize: 12, fontWeight: 600, textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                {item.role}
              </div>

              {/* Detail */}
              <div style={{ color: '#8d99a5', fontSize: 13, lineHeight: 1.6 }}>{item.detail}</div>
            </div>
          ))}
        </div>
      </Container>
